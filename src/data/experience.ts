...
export const otherExperience: Experience[] = [
  {
    ...
    achievements: [
      "Lead the organization in ensuring smooth and efficient operations during events and academic activities",
      "Promote organizational productivity, teamwork, and student engagement within the CICS community",
      "Coordinate cross-functional collaboration and manage public communication in hybrid environments",
      "Supervise major initiatives and strengthen overall organizational effectiveness",
    ],
